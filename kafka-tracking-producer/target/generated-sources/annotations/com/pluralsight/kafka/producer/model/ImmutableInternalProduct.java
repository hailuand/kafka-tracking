...
public final class ImmutableInternalProduct implements InternalProduct {
  ...
  public String toString() {
    return MoreObjects.toStringHelper("InternalProduct")
        .omitNullValues()
        .add("designType", designType)
        .add("color", color)
   ...
   *    .designType(com.pluralsight.kafka.producer.enums.DesignType) // required {@link InternalProduct#designType() designType}
   *    .color(com.pluralsight.kafka.producer.enums.Colors) // required {@link InternalProduct#color() color}
   *    .productType(com.pluralsight.kafka.producer.enums.ProductType) // required {@link InternalProduct#productType() productType}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private @Nullable DesignType designType;
