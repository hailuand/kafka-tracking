...
public final class ImmutableInternalUser implements InternalUser {
  ...
  public String toString() {
    return MoreObjects.toStringHelper("InternalUser")
        .omitNullValues()
        .add("userId", userId)
   ...
   *    .userId(com.pluralsight.kafka.producer.enums.UserId) // required {@link InternalUser#userId() userId}
  ...
  public static final class Builder {
    ...
    private @Nullable Date dateOfBirth;
